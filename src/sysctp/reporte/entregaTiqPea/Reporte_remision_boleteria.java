...
package sysctp.reporte.entregaTiqPea;
 ...
 * @author jarteaga
 */
public class Reporte_remision_boleteria 

{
  ...
  //private final String pie="/UTDVVCC/recursos/pie.png";
    ...
    public void ejecutarReporte(int  id_remision)
    {
        try
        {
        ...
        URL  in = this.getClass().getResource("/sysctp/reporte/entregaTiqPea/reporte_remision_boleteria.jasper");//Ruta del reporte maestro
        ...
        // parametros.put("pie",this.getClass().getResourceAsStream(pie));//Carga la imagen pie en el reporte
         ...
         jviewer.setTitle("UTDVVCC - Remision Boleteria a Peajes");
