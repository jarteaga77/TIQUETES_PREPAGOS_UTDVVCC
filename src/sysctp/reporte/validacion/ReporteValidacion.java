...
package sysctp.reporte.validacion;
...

{
  ...
  private final String logo="/sysctp/presentacion/recursos/encabezado.png";
    ...
    public void ejecutarReporte(long recibo)
    {
        ...
        URL  in = this.getClass().getResource("/sysctp/reporte/validacion/reporte_validacion.jasper");
        reporte = (JasperReport) JRLoader.loadObject( in );
         ...
         jviewer.setTitle("Validación Tiquetes -  Clientes UTDVVCC");
