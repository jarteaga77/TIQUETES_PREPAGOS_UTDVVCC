...
package sysctp.reporte.validacion.dependencia;
 ...
 * @author jarteaga
 */
public class ReporteValidacionDepe 

{
  ...
  private final String logo="/sysctp/presentacion/recursos/encabezado.png";
    ...
    public void ejecutarReporte(long recibo)
    {
        ...
        URL  in = this.getClass().getResource("/sysctp/reporte/validacion/dependencia/reporte_validacion_depe.jasper");
        reporte = (JasperReport) JRLoader.loadObject( in );
         ...
         jviewer.setTitle("Validación Tiquetes -  Dependencias UTDVVCC");
