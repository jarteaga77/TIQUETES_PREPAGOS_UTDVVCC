...
package sysctp.reporte.ventaDepeCat;
...

{
  ...
  private final String logo="/sysctp/presentacion/recursos/encabezado.png";
    ...
    public void ejecutarReporte(Date fechaIni, Date fechaFin)
    {
        ...
        URL  in = this.getClass().getResource("/sysctp/reporte/ventaDepeCat/ReportArqCatDep.jasper");
        reporte = (JasperReport) JRLoader.loadObject( in );
        URL  in1 = this.getClass().getResource("/sysctp/reporte/ventaDepeCat/subreporteArqueoCatDepe.jasper");//Ruta del reporte maestro
