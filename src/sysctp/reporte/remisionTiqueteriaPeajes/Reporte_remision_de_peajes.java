...
package sysctp.reporte.remisionTiqueteriaPeajes;
 ...
 * @author jarteaga
 */
public class Reporte_remision_de_peajes 

{
  ...
  //private final String pie="/UTDVVCC/recursos/pie.png";
    ...
    public void ejecutarReporte(long  id_remision)
    {
        try
        {
        ...
        URL  in = this.getClass().getResource("/sysctp/reporte/remisionTiqueteriaPeajes/reporte_remision_boleteria.jasper");//Ruta del reporte maestro
        reporte = (JasperReport) JRLoader.loadObject( in );//La variable de tipo JasperReport utiliza la clase JRLoadrer y el metodo loadObject y recibe como parametro una varible de tipo url con la ruta del reporte.
         ...
         parametros.put("remision",id_remision);//Nombre del parametro en el reporte y la variable q se le va asignar al parametro
        ...
        // parametros.put("pie",this.getClass().getResourceAsStream(pie));//Carga la imagen pie en el reporte
         ...
         jviewer.setTitle("UTDVVCC - Remision Boleteria de Peajes");
