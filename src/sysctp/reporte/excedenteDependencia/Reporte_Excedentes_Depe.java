...
package sysctp.reporte.excedenteDependencia;
 ...
 * @author jarteaga
 */
public class Reporte_Excedentes_Depe 

{
  ...
  //private final String pie="/UTDVVCC/recursos/pie.png";
    ...
    public void ejecutarReporte(long  recibo)
    {
        ...
        URL  in = this.getClass().getResource("/sysctp/reporte/excedenteDependencia/Excedente_depe.jasper");//Ruta del reporte maestro
        ...
        // parametros.put("pie",this.getClass().getResourceAsStream(pie));//Carga la imagen pie en el reporte
         ...
         jviewer.setTitle("SYSCTP - Cancelación Excedentes - Dependencia  ");
