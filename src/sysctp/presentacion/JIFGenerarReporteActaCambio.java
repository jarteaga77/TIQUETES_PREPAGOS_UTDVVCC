 ...
 * @author jarteaga
 */
public class JIFGenerarReporteActaCambio extends javax.swing.JInternalFrame {
    
    private ReporteActaCambio jasper;

    public JIFGenerarReporteActaCambio() {
        initComponents();
        jasper=new ReporteActaCambio();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("SYSCTP-Reporte Acta de Cambio");
