 ...
 * @author jarteaga
 */
public class JIFImprimirValidacionTiquetesClientes extends javax.swing.JInternalFrame {

    private ReporteValidacion reporte;
    public JIFImprimirValidacionTiquetesClientes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("SYSCTP- Imprimir Validación Tiquetes a Clientes");
        setToolTipText("");
