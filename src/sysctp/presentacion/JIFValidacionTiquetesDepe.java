...
import sysctp.dominio.ventas.DaoDetalleValidacionDepe;
import sysctp.dominio.ventas.DaoPagoValidacionesDepe;
import sysctp.dominio.ventas.DaoValidacionTiquetesDependencia;
import sysctp.dominio.ventas.DetalleValidacionDepe;
import sysctp.dominio.ventas.PagoValidacionesDepe;
import sysctp.dominio.ventas.Validacion_Tiquetes_Dependencia;
import sysctp.reporte.validacion.dependencia.ReporteValidacionDepe;
/**
 *
 * @author jarteaga
 */
public class JIFValidacionTiquetesDepe extends javax.swing.JInternalFrame {
    ...
    public JIFValidacionTiquetesDepe() {
        initComponents();
     ...
     try
    {
        ...
        ResultSet obj1=nueva.executeQuery("SELECT MAX(id_validacion)+1 as id_validacion FROM ventas.validacion_tiquetes_dependencias");
        
         while(obj1.next())
        {
            txt_id_validacion.setText(String.valueOf(obj1.getLong("id_validacion")));
        }
        ...
        while(obj.next())
        {
            cb_depe.addItem(obj.getObject("depe_descripcion"));//Llena JCombobox con el nombre del centro de costos
        }
    ...
    public static void settxtIDEspecificacion(int  id) {
        JIFValidacionTiquetesDepe.txt_id_esp.setText(String.valueOf(id));
    }
    ...
    public static void settxtIDFormaPago(int  id) {
        JIFValidacionTiquetesDepe.txt_id_fp.setText(String.valueOf(id));
    }
    ...
    public static void settxtIDCtaBan(int  id) {
        JIFValidacionTiquetesDepe.txt_ctaban.setText(String.valueOf(id));
    }
    ...
    private void initComponents() {
        ...
        cb_itemdepe = new javax.swing.JComboBox();
        jLabel6 = new javax.swing.JLabel();
        cb_depe = new javax.swing.JComboBox();
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(txt_id_esp, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Sistema de Control Tiquetes Prepagos -Validación Tiquetes  Dependencias");
        ...
        clientePanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Dependencia"));

        jLabel6.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel6.setText("Dependencia:");

        cb_depe.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cb_depeActionPerformed(evt);
            }
        });
        ...
        clientePanelLayout.setHorizontalGroup(
            ...
            .addGroup(clientePanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cb_depe, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cb_itemdepe, javax.swing.GroupLayout.PREFERRED_SIZE, 276, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        clientePanelLayout.setVerticalGroup(
            ...
            .addGroup(clientePanelLayout.createSequentialGroup()
                ...
                .addGroup(clientePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cb_itemdepe, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6)
                    .addComponent(cb_depe, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        Validacion_Tiquetes_Dependencia validacion=new Validacion_Tiquetes_Dependencia();
        DaoValidacionTiquetesDependencia daovalidacion=new DaoValidacionTiquetesDependencia();
      
       long id_item=0;
       int id_usurio= principal.getSeccion();
       ConexionBD nuevaCone=new ConexionBD();
  
             if(cb_itemdepe.getSelectedItem()!=null)
            {
            try {
                String item=cb_itemdepe.getSelectedItem().toString();
                ResultSet obj=nuevaCone.executeQuery("SELECT id_item_depen FROM dependencias.item_dependencia WHERE item_depen_descrip='"+item+"'");
                
                while(obj.next())
                {
                    id_item=obj.getLong("id_item_depen");
                }
            } catch (SQLException ex) {
                Logger.getLogger(JIFValidacionTiquetesDepe.class.getName()).log(Level.SEVERE, null, ex);
            }
            }
             ...
             validacion.setId_itemDependencia(id_item);
    ...
    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
        try
        {
            ...
            DetalleValidacionDepe detalle=new DetalleValidacionDepe();
            DaoDetalleValidacionDepe daoDetalle=new DaoDetalleValidacionDepe();
            
            ResultSet obj=nueva.executeQuery("SELECT id_validacion FROM ventas.validacion_tiquetes_dependencias WHERE id_validacion="+txt_id_validacion.getText()+"");
       ...
       ConexionBD nuevaCone=new ConexionBD();
            ...
            try {
                String item=cb_itemdepe.getSelectedItem().toString();
                ResultSet obj1=nuevaCone.executeQuery("SELECT id_item_depen FROM dependencias.item_dependencia WHERE item_depen_descrip='"+item+"'");
                
                while(obj1.next())
                {
                    id_item=obj1.getLong("id_item_depen");
                }
            } catch (SQLException ex) {
                Logger.getLogger(JIFValidacionTiquetesDepe.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void btn_aceptar_fpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptar_fpActionPerformed
      ...
      PagoValidacionesDepe pago=new PagoValidacionesDepe();
      DaoPagoValidacionesDepe daoPago=new DaoPagoValidacionesDepe();
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(tableLineasVenta.isRowSelected(tableLineasVenta.getSelectedRow()))
        {
           ...
           nuevaCone.executeUpdateQuery("DELETE FROM ventas.detalle_validacion_dependencias WHERE id_dv="+modelo.getValueAt(row,0)+" AND id_validacion="+txt_id_validacion.getText()+"");
    ...
    private void btnEliminarPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarPagoActionPerformed
        ...
        {
           nuevaCone.executeUpdateQuery("DELETE FROM ventas.pago_validacion_depe WHERE id_pa_va="+modeloPago.getValueAt(row,0)+" AND id_validacion="+txt_id_validacion.getText()+"");
        }
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        nuevaCone.executeUpdateQuery("BEGIN;"
                + "DELETE FROM ventas.detalle_validacion_dependencias WHERE id_validacion="+txt_id_validacion.getText()+";"
                + "DELETE FROM ventas.pago_validacion_depe WHERE id_validacion="+txt_id_validacion.getText()+";"
                + "DELETE FROM ventas.validacion_tiquetes_dependencias WHERE id_validacion="+txt_id_validacion.getText()+";"
                + "ROLLBACK;"
                + "COMMIT;");
    ...
    private void cb_depeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_depeActionPerformed
          try
        {
            int id_depen=0;
            ConexionBD nuevaCone=new ConexionBD();

            if(cb_depe.getSelectedItem()!=null)
            {
                String depen=cb_depe.getSelectedItem().toString();
            ...
            while(obj2.next())
            {
                cb_itemdepe.addItem(obj2.getObject("item_depen_descrip"));
            }
            nuevaCone.desconectar();
    ...
    }//GEN-LAST:event_cb_depeActionPerformed
    ...
    private javax.swing.JComboBox cb_depe;
    private javax.swing.JComboBox cb_itemdepe;
   ...
   public void LimpiarTablaPago()
    ...
    public void consultaDetalleTabla()
    {
      ...
      ResultSet obj=nuevaCone.executeQuery("SELECT dv.id_dv,dv.cantidad,(cat.cat_nombre ||'-'||tea.tea_nombre)AS descripcion,"
              ...
              + "FROM ventas.validacion_tiquetes_dependencias va JOIN ventas.detalle_validacion_dependencias dv ON va.id_validacion=dv.id_validacion "
              ...
              + "WHERE va.id_validacion="+txt_id_validacion.getText()+" ORDER BY dv.id_dv");
        try {
            while (obj.next()) 
                  {
     ...
     public void detalleTablaFormaPago()
    {
        ...
        ResultSet obj=nuevaCone.executeQuery("SELECT pa.id_pa_va,fp.fp_descripcion,cta.cban_numero,cta.cban_banco, to_char(pa.pago_validacion,'999G999G999G999D99') "
                + "FROM ventas.validacion_tiquetes_dependencias va JOIN ventas.pago_validacion_depe pa ON va.id_validacion=pa.id_validacion "
                + "JOIN ventas.forma_de_pago fp ON pa.id_fp=fp.fp_id "
                + "JOIN ventas.cuenta_bancaria cta ON cta.cban_id=pa.id_ctaban "
                + "WHERE va.id_validacion="+txt_id_validacion.getText()+"");
        try {
            while (obj.next())
            {
                Object [] datos = new Object[5];
    ...
    public void totalValidacion()
    {
        ...
        ResultSet obj=nuevaCone.executeQuery("SELECT to_char(SUM((dv.cantidad)*(dv.vlor_validacion)),'999G999G999G999D99') AS total "
                + "FROM ventas.validacion_tiquetes_dependencias va JOIN ventas.detalle_validacion_dependencias dv ON dv.id_validacion=va.id_validacion "
                + "WHERE va.id_validacion="+txt_id_validacion.getText()+"  ");
        try {
            while(obj.next())
            {
