...
import sysctp.reporte.canExcedente.Reporte_Excedentes;

/**
 *
 * @author jarteaga
 */
public class JIFReciboExcedente extends javax.swing.JInternalFrame {

   private Reporte_Excedentes jasper;
    public JIFReciboExcedente() {
        initComponents();
        jasper=new Reporte_Excedentes();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Recibo de Caja Excedentes");
        setToolTipText("");
