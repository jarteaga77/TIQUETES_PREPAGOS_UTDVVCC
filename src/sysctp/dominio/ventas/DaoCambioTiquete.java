...

{
    ...
    public static void setId_actaCambio(long id_actaCambio) {
        DaoCambioTiquete.id_actaCambio = id_actaCambio;
    }

    
    
    public DaoCambioTiquete() {

    }
    
    public void guardar(CambioTiquete ctp)
    {
            ResultSet obj =nueva.executeQuery("INSERT INTO ventas.cambio_tiquete(fecha,clie_sede,nombre_persona_recibe,apellido_persona_recibe,cedula_persona_recibe, observaciones, id_usuario)VALUES('"+ctp.getFecha()+"',"+ctp.getCliente_sede()+",'"+ctp.getNombre()+"','"+ctp.getApellido()+"',"+ctp.getCedula()+", '"+ctp.getObservaciones()+"', "+ctp.getId_usuario()+")RETURNING id_acta_consecutivo"); 
        ...
        try {
            ...
            Logger.getLogger(DaoCambioTiquete.class.getName()).log(Level.SEVERE, null, ex);
        }
