 ...
 * @author jarteaga
 */
public class DaoDetalleTQEntregados 
{
    
    private ConexionBD nueva=new ConexionBD();

    
    public void guardar(DetalleTiquetesEntregados detalleTE)
    {
          ...
          if (obj1.next()==true)
          {
           ...
           long minimo=obj1.getLong("minimo");
            ...
            if(obj.next()==true)
            {
                ...
                nueva.executeUpdateQuery("INSERT INTO ventas.detalle_entregados (id_esp_tiquete,consecutivo_inicial,consecutivo_final,id_actacambio)"
