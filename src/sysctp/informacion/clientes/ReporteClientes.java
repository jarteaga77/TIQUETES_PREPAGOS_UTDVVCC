...
package sysctp.informacion.clientes;


import sysctp.reportes.*;
import java.net.URL;
...

{
  ...
  private final String logo="/sysctp/presentacion/recursos/encabezado.png";//Ruta del logo de la empresa
    ...
    public void ejecutarReporte()
    {
        ...
        URL  in = this.getClass().getResource("/sysctp/informacion/clientes/Informacion_clientes.jasper");//Ruta del reporte maestro
        ...
        // parametros.put("entregados", subreporteEntregados);//Nombre del parametro en el reporte y la variable q se le va asignar al parametro
         ...
         jviewer.setTitle("SYSCTP Base de datos Clientes");
